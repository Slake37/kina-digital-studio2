...
const Reviews = () => {
  return (
    <div className="max-w-[1440px] mx-auto text-[#FAF9F6] p-3 flex flex-col justify-start items-start mt-5">
      <h1 className="text-3xl font-semibold">Happy Clients, Happy Stories.</h1>
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
